def get_chatting_url(requests, conn, server):
    """
    ...
    from chatting.function import split_requests
    ...
    requests = split_requests(requests)
    for request in requests:
        try:
            func = chatting_urls_dict[request[0]]
            args = request[1:]
